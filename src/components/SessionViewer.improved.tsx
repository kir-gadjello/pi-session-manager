        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-border">
          <div className="flex items-center gap-2 min-w-0">
            <button
              ...
              className="p-1.5 text-muted-foreground hover:text-foreground hover:bg-secondary rounded transition-colors flex-shrink-0"
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              onClick={onRename}
              className="px-3 py-1 text-xs bg-secondary hover:bg-secondary-hover rounded transition-colors"
            >
              {t('common.rename')}
            </button>
            <button
