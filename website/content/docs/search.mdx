...
Search results display highlighted snippets showing the matching text in context. Click a result to jump directly to the matching message in the [Session Viewer](./session-viewer).
