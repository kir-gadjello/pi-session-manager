...
<Cards>
  <Card title="安装指南" href="/docs/installation" description="各平台的详细安装说明" />
  <Card title="会话浏览器" href="/docs/session-browser" description="浏览和管理你的会话" />
  <Card title="搜索系统" href="/docs/search" description="带过滤器的全文搜索" />
  <Card title="架构概览" href="/docs/architecture" description="了解整体架构设计" />
</Cards>
