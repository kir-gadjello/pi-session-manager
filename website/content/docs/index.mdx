...
<Cards>
  <Card title="Installation" href="/docs/installation" description="Detailed setup for all platforms" />
  <Card title="Session Browser" href="/docs/session-browser" description="Browse and organize your sessions" />
  <Card title="Search" href="/docs/search" description="Full-text search with filters" />
  <Card title="Architecture" href="/docs/architecture" description="How it all fits together" />
</Cards>
