...
pub fn render() -> String {
    ...
    out.push_str(&format!("write_buffer_details_size {}\n", WRITE_BUFFER_DETAILS_SIZE.load(Ordering::Relaxed)));

    out.push_str("# HELP message_entries_count Current number of entries in message_entries index\n");
    out.push_str("# TYPE message_entries_count gauge\n");
    out.push_str(&format!("message_entries_count {}\n", MESSAGE_ENTRIES_COUNT.load(Ordering::Relaxed)));
